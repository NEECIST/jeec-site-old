        ...
        <div class="speaker-card" v-for="speaker in speakers" :key="speaker.name">
            ...
            <div class="speaker-card-bottom">
              <div class="speaker-links">
                ...
                <a v-if="speaker.youtube_url.length" :href="speaker.youtube_url" target="_blank"><img v-if="speaker.youtube_url.length" class="speaker-link-logo" src="../../static/youtube.svg"/></a>
              </div>
