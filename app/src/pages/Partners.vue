<template>
    <div class="partners-app">
        ...
        <div style="display: flex; align-items: center; justify-content: center">
            <a v-if="partners.main_sponsor.length > 0 && partners.main_sponsor[0].link" v-for="main in partners.main_sponsor" v-bind:key="main.name" v-bind:href="main.link" target="_blank">
                <img class="main-sponsor-logo" :src="jeec_api_url + main.logo"> 
            </a>
            <div v-else>
                    <img v-if="partners.main_sponsor[0].logo!=null" class="partner-logo" :src="jeec_api_url + partners.main_sponsor[0].logo">
